 ...
 */
final class Version20200303095621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE status_id status_id INT DEFAULT NULL, CHANGE role_id role_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE role_id role_id INT NOT NULL, CHANGE status_id status_id INT NOT NULL');
